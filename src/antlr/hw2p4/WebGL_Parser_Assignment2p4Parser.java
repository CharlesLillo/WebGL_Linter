...
public class WebGL_Parser_Assignment2p4Parser extends Parser {
	...
	@Override
	public String getGrammarFileName() { return "WebGL_Parser_Assignment2p4.g4"; }
	...
	public WebGL_Parser_Assignment2p4Parser(TokenStream input) {
		super(input);
	...
	public static class DocumentContext extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof WebGL_Parser_Assignment2p4Visitor ) return ((WebGL_Parser_Assignment2p4Visitor<? extends T>)visitor).visitDocument(this);
	...
	public static class HtmlElementContext extends ParserRuleContext {
		public TerminalNode Whitespace(int i) {
			return getToken(WebGL_Parser_Assignment2p4Parser.Whitespace, i);
		}
		public List<TerminalNode> Whitespace() { return getTokens(WebGL_Parser_Assignment2p4Parser.Whitespace); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof WebGL_Parser_Assignment2p4Visitor ) return ((WebGL_Parser_Assignment2p4Visitor<? extends T>)visitor).visitHtmlElement(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class HeadElementContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof WebGL_Parser_Assignment2p4Visitor ) return ((WebGL_Parser_Assignment2p4Visitor<? extends T>)visitor).visitHeadElement(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ContentContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof WebGL_Parser_Assignment2p4Visitor ) return ((WebGL_Parser_Assignment2p4Visitor<? extends T>)visitor).visitContent(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ChardataContext extends ParserRuleContext {
		public TerminalNode SEA_WS() { return getToken(WebGL_Parser_Assignment2p4Parser.SEA_WS, 0); }
		public TerminalNode TEXT() { return getToken(WebGL_Parser_Assignment2p4Parser.TEXT, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof WebGL_Parser_Assignment2p4Visitor ) return ((WebGL_Parser_Assignment2p4Visitor<? extends T>)visitor).visitChardata(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class VertexCodeScriptContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof WebGL_Parser_Assignment2p4Visitor ) return ((WebGL_Parser_Assignment2p4Visitor<? extends T>)visitor).visitVertexCodeScript(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class FragmentCodeScriptContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof WebGL_Parser_Assignment2p4Visitor ) return ((WebGL_Parser_Assignment2p4Visitor<? extends T>)visitor).visitFragmentCodeScript(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class JavascriptContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof WebGL_Parser_Assignment2p4Visitor ) return ((WebGL_Parser_Assignment2p4Visitor<? extends T>)visitor).visitJavascript(this);
			else return visitor.visitChildren(this);
		}
	}
